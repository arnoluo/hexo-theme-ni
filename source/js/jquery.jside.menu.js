...
(function($){
  $.fn.jSideMenu = function(options){
    var setting = $.extend({
      ...
      jSideSkin: "black-grey", // to apply custom skin, just put its name in this string
      jSideTransition: 15, //Define the transition duration in milliseconds 
      }, options);
    return this.each(function() {
      ...
      $(dHeading).click(function(){
        $(this).parent().find("div").slideToggle(setting.jSideTransition);
